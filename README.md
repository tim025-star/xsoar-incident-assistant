...
The bounded input limits are 96 KiB, depth 30, and 10,000 visited nodes. CPU microbatches contain at most 16 sequences and 4,096 padded tokens. Automatic mode selects 1/2/4 workers according to processor count and available RAM; manual mode supports 1–4 subject to pending work and a memory safety check. Workers reserve two logical processors for the application/OS and share the remaining thread budget.
